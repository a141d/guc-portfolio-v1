...
import { Search, Filter, Folder, Star, BookOpen, User, Calendar, ArrowUpDown, AlertTriangle, EyeOff, Heart } from 'lucide-react';
              ...
              <div className="absolute top-4 right-4 flex flex-col gap-2 items-end">
                ...
                {canSaveFavorites && (
                  <button 
                    ...
                    className="p-2 bg-white rounded-full border border-gray-100 hover:bg-red-50 text-gray-400 hover:text-red-500 shadow-sm transition-all hover:scale-110"
